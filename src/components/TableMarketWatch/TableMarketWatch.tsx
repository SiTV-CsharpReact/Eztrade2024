...
const TableMarketWatch = () => {
  ...
  const { Exchange, statusTradingView, stockCode } = useAppSelector(
    (state) => state.chartTradingView
  );
  const handleClose = () =>
    dispatch(setStatusTradingView({ statusTradingView: false }));
  ...
  return (
    <section className="w-full h-[701px] bg-[#1A1D1F]">
      <div className="price-board_header h-[35px] bg-[#272B30]">
        <div className="price-board-header px-2 flex">
          ...
          <div className="flex space-x-2">
            ...
            <button
              type="button"
              className="btn button-control mt-0.5 rounded h-[28px] text-white small bg-[#1aaf74] text-xs font-medium w-18 xl:w-24"
              tabIndex={-1}
            >
              Đặt lệnh
            </button>
      ...
      <div className="price-board_table">{/* <LineChartGradient/> */}</div>
      <TablePrice />
      {/* <SearchStockCode/> */}
      ...
      <div className="h-[30px] relative">
        <Tabs
          defaultActiveKey="1"
          onChange={callback}
          className="custom-tabs pl-2"
        >
          <TabPane
            tab={
              <button
                type="button"
                className="btn button-control mt-0.5 rounded h-[28px] text-white small bg-[#1aaf74] text-xs font-medium w-18 xl:w-24 custom-tab"
                tabIndex={-1}
              >
                Đặt lệnh
              </button>
            ...
            key="1"
          >
            <div className="flex gap-2 p-2 justify-evenly text-white">
              <div>Tài khoản</div>
              <div>mã</div>
              <div>Thông tin đặt lệnh</div>
              <div>Khối lượng</div>
              <div>Thông tin</div>
            </div>
          </TabPane>
          <TabPane
            tab={<span className="custom-tab">Lệnh chờ khớp</span>}
            key="2"
          >
            Content of Tab Pane 2
          </TabPane>
          <TabPane
            tab={<span className="custom-tab">KQ khớp lệnh trong phiên</span>}
            key="3"
          >
            Content of Tab Pane 3
          </TabPane>
          <TabPane
            tab={<span className="custom-tab">Lệnh trong ngày</span>}
            key="4"
          >
            Content of Tab Pane 3
          </TabPane>
        ...
        <div className="absolute top-0 right-0 pr-3 pt-2">
          {/* <Button style={{height:24,width:24,padding:'none'}}><UpIndexIcon height="1.2em"/></Button> */}
          <Button shape="circle" style={{height:24,width:24,minWidth:24,padding:'0px'}} icon={<UpIndexIcon height="1em"/>} />
          <Button shape="circle" style={{height:24,width:24,minWidth:24,padding:'0px'}} icon={<DownIndexIcon height="1.4em"/>} />
          </div>
      </div>
    </section>
  );
